...
**发布说明：** 论文、引用和代码链接将在 camera-ready 与 artifact release 流程完成后补充。
...
1. **Vision-to-Concept Tokenization：** 将冻结视觉 backbone 的密集视觉特征投影到离散视觉概念词表，降低对抽象或非视觉 LLM 生成概念的依赖。
...
论文已被 ECCV 2026 接收。公开 PDF、引用元数据和代码仓库链接将在 camera-ready 与 artifact release 流程就绪后补充。
